...
public class AutomationTest extends BaseTest {
    ...
    @Test
    public void testAllProductsNavigation1() throws InterruptedException {
    ...
    @Test
    public void testFindArticle1() throws InterruptedException {
    ...
    @Test
    public void testEightComponents1() {
    ...
    @Test
    public void testAllProductsNavigationYS1() throws InterruptedException {
        final String expectedProductsUrl = "https://automationexercise.com/products";
        final String expectedHeader = "ALL PRODUCTS";
    ...
    @Test
    void testVerifyScrollUpUsingArrowButtonAndScrollDown1()
    ...
    public void testSubscriptionInCartPage1()
            throws InterruptedException {
    ...
    @Test(invocationCount = 1)
    public void testAddReviewOnProduct1()
            throws InterruptedException {
